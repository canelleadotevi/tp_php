        ...
        <form action="{{ route('student') }}" method="post"
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <div>
                    ...
                    <input type="text" name="lastname" id="" class="form-control mb-4 py-3 px-4"autocomplete="off">
                </div>

                <div class="form_item">
                    <label for="firstname" class="d-flex justify-content-start  fs-4 fw-1  pb-2">Prenom</label>
                    <input type="text" name="firstname" id="" class="form-control mb-4 py-3 px-4" autocomplete="off">
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center ">
                <div class="form_item">
                    ...
                    <input type="date" name="birthday" id="" class="form-control mb-4 py-3 px-4" autocomplete="off">
                </div>
    
                <div class="form_item">
                    <label for="hobbies" class="d-flex justify-content-start  fs-4 fw-1 pb-2">Hobbies</label>
                    <input type="text" name="hobbies" id="" class="form-control mb-4 py-3 px-4" autocomplete="off">
                </div>
            </div>

            <div class="form_item">
                <label for="speciality" class="d-flex justify-content-start  fs-4 fw-1 pb-2">Specialité</label>
                <input type="text" name="speciality" id="" class="form-control mb-4 py-3 px-4" autocomplete="off">
            </div>

            <div class="form_item">
                <label for="bio" class="d-flex justify-content-start  fs-4 fw-1 pb-2">Biographie</label>
                <textarea name="bio" id="" cols="31" rows="10" class="form-control mb-4 "></textarea>
            </div>
