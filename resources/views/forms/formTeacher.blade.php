    ...
    <form action="{{route('teacherUpdate',$data->id)}}" method="post"
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <div>
                    ...
                    <input value="{{$data->lastname}}" type="text" name="lastname" id="" class="form-control mb-4 py-3 px-4"autocomplete="off">
                </div>

                <div>
                    <label for="firstname" class="d-flex justify-content-start   pb-2 fs-4 fw-1">Prénom</label>
                    <input value="{{$data->firstname}}" type="text" name="firstname" id="" class="form-control mb-4 py-3 px-4"autocomplete="off" >
                </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <div>
                    ...
                    <input value="{{$data->address}}" type="text" name="address" id="" class="form-control mb-4 py-3 px-4"autocomplete="off" >
                </div>
                <div  >
