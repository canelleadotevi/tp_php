...
@section('content')
    ...
    <section>
        @if (session('suggest'))
            <div class="alert alert-dismissible alert-warming fade show text-center
    " role="alert">
    ...
    <div class="container">
        <form class=" form" action="{{ route('registerStore') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
                <div class="mt-3 mb-3 me-3">
                    ...
                    <div class="my-2">
                        ...
                        <input type="text" value="{{ old('firstname') }}" name="firstname"
                            class="form-control px-2 mb-2 py-1 " autocomplete="off">
                    </div>
                    ...
                    <div class="my-2">
                        ...
                        <input type="email" value="{{ old('email') }}" name="email" class="form-control px-2 mb-2 py-1"
                            autocomplete="off">
                    </div>
                    ...
                    <div class="my-2">
                        <label for="password_confirm" class="mb-2 text-secondary  fs-5"> Confirmation de Mot de
                            passe</label>
                        <input type="password" name="password_confirmation" class="form-control px-2 mb-2 py-1 "
                            autocomplete="off">
                    </div>

                    <div class="d-flex justify-content-end mt-5">
                        <button type="submit"
                            class=" px-3 py-2 rounded  text-white bg-primary border border-primary fs-5">Connexion</button>
                    </div>
