...
<body>
    <header>
        <nav class="bg-white d-flex justify-content-between py-3 px-3" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
            <div class="" >
                <a href="/" class="text-decoration-none fs-3 " style="font-style:italic;"><img src="{{asset('imagesProjet/ecole229.jpg')}}" alt=""></a>
            </div>
            <div class="text-center ">
                <a href="/" class="text-decoration-none fs-3 " style="font-style:italic;"><span></span></a>
            </div>
